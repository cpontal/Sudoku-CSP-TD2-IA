...
for i in range(1,n+1):
    ...
    resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingLCV(sudokuBacktrackingLCV)
print("Le temps mis par le backtrackingLCV pour l'ensemble des sudokus est : {} s" .format(time.time()-tempsTotalBacktrackingLCV))
...
for i in range(1,n+1):
    ...
    resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingDegreeHeuristic(sudokuBacktrackingDH)
print("Le temps mis par le backtrackingDH pour l'ensemble des sudokus est : {} s" .format(time.time()-tempsTotalBacktrackingDH))