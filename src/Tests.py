...
resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingLCV(sudokuBacktrackingLCV)
print("Le temps mis par le backtrackingLCV est : {} s" .format(time.time()-sudokuBacktrackingLCVt1))

######## DH ##########
sudokuBacktrackingDHt1 = time.time()
resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingDegreeHeuristic(sudokuBacktrackingDH)
print("Le temps mis par le backtrackingDH est : {} s" .format(time.time()-sudokuBacktrackingDHt1))
...
for i in range(n):
    ...
    resolutionMRVamelio.backtracking(sudokuBacktracking)
print("Le temps mis par le backtracking pour l'ensemble des sudokus est : {} s" .format((time.time()-tempsTotalBacktracking)/n))
...
for i in range(n):
    ...
    resolutionMRVamelio.backtrackingMRV(sudokuBacktrackingMRV)
print("Le temps mis par le backtrackingMRV pour l'ensemble des sudokus est : {} s" .format((time.time()-tempsTotalBacktrackingMRV)/n))
...
for i in range(n):
    ...
    resolutionAC3.backtrackingAC3(sudokuBacktrackingAC3)
print("Le temps mis par le backtrackingAC3 pour l'ensemble des sudokus est : {} s" .format((time.time()-tempsTotalBacktrackingAC3)/n))
...
for i in range(n):
    ...
    resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingLCV(sudokuBacktrackingLCV)
print("Le temps mis par le backtrackingLCV pour l'ensemble des sudokus est : {} s" .format((time.time()-tempsTotalBacktrackingLCV)/n))
...
for i in range(n):
    ...
    resolutionLeastConstrainingValue_DegreeHeuristic.backtrackingDegreeHeuristic(sudokuBacktrackingDH)
print("Le temps mis par le backtrackingDH pour l'ensemble des sudokus est : {} s" .format((time.time()-tempsTotalBacktrackingDH)/n))